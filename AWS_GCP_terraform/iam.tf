...
resource "aws_iam_role_policy_attachment" "eks_policy_attachment" {
  ...
  policy_arn = "arn:aws:iam::038462785952:policy/eks-cluster-admin-policy"
}
...
resource "aws_iam_role_policy" "lambda_policy" {
  name   = "lambda_sns_cloudwatch_policy"
...
data "aws_iam_policy_document" "lambda_policy" {
  statement {
    actions   = ["sns:Subscribe", "sns:ListSubscriptions", "cloudwatch:PutMetricAlarm"]
    resources = [aws_sns_topic.mysqldb_sns.arn, aws_sns_topic.tomcatwas_sns.arn]
  }
}
...
resource "aws_iam_role_policy" "lambda_sns_cloudwatch_policy" {
  name = "lambda-sns-cloudwatch-policy"
